 ...
 */
export function translateToHuman(data: CLowlMessageData): string {
 ...
 */
export function translateJsonToHuman(jsonStr: string): string {
 ...
 */
export function translateBatch(messages: CLowlMessageData[]): string[] {
 ...
 */
export function translateTrace(messages: CLowlMessageData[], tid: string): string {
 ...
 */
export function translateConversation(messages: CLowlMessageData[], cid: string): string {
 ...
 */
export function parseJsonl(jsonl: string): CLowlMessageData[] {
  const messages: CLowlMessageData[] = [];
  const lines = jsonl.split("\n").filter((line) => line.trim());

  for (const line of lines) {
    try {
      const data = JSON.parse(line) as CLowlMessageData;
